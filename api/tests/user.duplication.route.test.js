 ...
 * User routes tests
 */
describe('User duplication tests', function() {
  ...
  it('should be unable to register user with same username', function(done) {
    var user = _.clone(_user);
  ...
  it('should be unable to register user with same email', function(done) {
    var user = _.clone(_user);
